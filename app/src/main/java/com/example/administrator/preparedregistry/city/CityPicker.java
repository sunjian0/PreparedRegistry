package com.example.administrator.preparedregistry.city;
...
import com.example.administrator.preparedregistry.city.ScrollerNumberPicker.OnSelectListener;
...
//					System.out.println("endselect");
    ...
    public String getCity_string() {
        ...
        } else if (cityPicker.getSelectedText().equals("县")) {
            city_string = provincePicker.getSelectedText()
                    + counyPicker.getSelectedText();
        } else if (cityPicker.getSelectedText().equals("市")) {
            city_string = provincePicker.getSelectedText()
                    + counyPicker.getSelectedText();
        } else {
            city_string = provincePicker.getSelectedText()
